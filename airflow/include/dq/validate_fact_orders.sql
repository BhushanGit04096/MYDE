...
END
FROM `playground-s-11-82a9d55d.retail_warehouse.fact_orders`;
...
FROM (
    ...
    FROM `playground-s-11-82a9d55d.retail_warehouse.fact_orders` f
    LEFT JOIN `playground-s-11-82a9d55d.retail_warehouse.dim_customers` d
